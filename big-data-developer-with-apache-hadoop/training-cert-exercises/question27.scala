 ...
 */
//Explanation: Solution XXX: --class com.hadoopexam.MyTask YYY : --deploy-mode cluster
$ spark-submit --class com.hadoopexam.MyTask --master yarn --deploy-mode cluster SPARK_HOME/lib/hadoopexam.jar 10