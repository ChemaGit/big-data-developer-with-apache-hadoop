...
$ hive
  hive> CREATE TABLE flumemaleemployee1(sex int,name string,city string) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE LOCATION '/user/hive/warehouse/flumemaleemployee1';
hive> CREATE TABLE flumefemaleemployee1(sex int,name string,city string) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE LOCATION '/user/hive/warehouse/flumefemaleemployee1';
