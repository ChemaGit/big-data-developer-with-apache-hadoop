/** Question 33
  ...
  * value found for department_name column replace it with "NA" (string) and for avg column with -999
  * select * from departments_hive01;
  */
$ hive
  hive> use hadoopexam;
hive> create table departments_hive01(department_id int,department_name string, avg_salary int);
