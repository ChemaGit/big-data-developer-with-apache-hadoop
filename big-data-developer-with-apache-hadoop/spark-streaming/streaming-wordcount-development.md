...
- import org.apache.spark.streaming._ to import all the APIs
  ...
  - Pass Spark Configuration object and number of seconds to Streaming Context object. 
    This will facilitate the Streaming Context to queue up the data for the interval equal to number of seconds and apply logic for processing.
