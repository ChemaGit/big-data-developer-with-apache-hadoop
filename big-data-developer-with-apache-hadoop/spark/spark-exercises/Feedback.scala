...
/** ABCTECH.com has done survey on their Exam Products feedback
...
object Feedback {
    ...
    val spark = SparkSession
      ...
      .config("spark.app.id", "Feedback")  // To silence Metrics warning
      .getOrCreate()

    val sc = spark.sparkContext

    val input = "hdfs://quickstart.cloudera/user/cloudera/files/feedback.txt"
    val output = "hdfs://quickstart.cloudera/user/cloudera/feedback/"
    ...
    def main(args: Array[String]): Unit = {
        ...
        try {
            ...
            //      check the results
            //      $ hdfs dfs -ls /user/cloudera/feedback/good
            //      $ hdfs dfs -cat /user/cloudera/feedback/good/part*
            //      $ hdfs dfs -ls /user/cloudera/feedback/bad
            //      $ hdfs dfs -cat /user/cloudera/feedback/bad/part*
