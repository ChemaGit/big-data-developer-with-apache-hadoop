...
#b. Extraiga solo las columnas acct_num, first_name, last_name, city, state, y zipcode.
#c. Solamente para aquellas cuentas cuyo campo first_name comience por la letra D.
...
#f. Esto se puede hacer mediante la opcion --outdir /tmp.
