...
$ hive
  hive> use hadoopexam;
hive> create table flumemaleemployee(name string, salary int, sex string, age int) row format delimited fields terminated by ',' location '/user/hive/warehouse/hadoopexam.db/flumemaleemployee';
hive> show tables;
